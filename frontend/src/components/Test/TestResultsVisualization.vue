  ...
  <div class="tests-visualization" v-if="isAnalyzing || analysisComplete">
    <div class="tests-header">
      <h3 class="cyber-heading">
        ...
        <span class="completion-badge" v-if="analysisComplete">
          ЗАВЕРШЕНО
        </span>
      </h3>
    ...
    <div class="analysis-results" v-if="analysisComplete">
      <div class="results-header">
        <h3 class="cyber-heading">
          <span class="text-primary">РЕЗУЛЬТАТЫ АНАЛИЗА</span>
        </h3>
      ...
      <div class="results-actions">
        <button class="cyber-button repeat-button" @click="$emit('repeat-analysis')">
          <span class="button-icon">🔄</span>
          <span class="button-text">ПОВТОРИТЬ АНАЛИЗ</span>
        </button>
      </div>
    </div>
  </div>
